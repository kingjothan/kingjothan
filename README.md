...
Includes Google Maps, payments, job tracking, and real-time notifications.  
💬 Handles requests and updates with **Socket.io** and **Firebase**.
...
- Designed APIs used by both web and mobile clients.  
- Integrated payment systems across platforms.  
- Converted modern projects to **pure HTML, CSS, and JS** when needed.  
- Focused on communication, reliability, and delivery.  

🎯 Current Focus  

- Refining *UrbanHandy* backend performance.  
- Exploring *NativePHP* for hybrid web apps.  
- Improving developer documentation and internal tools.  
